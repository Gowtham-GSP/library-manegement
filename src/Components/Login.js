                    ...
                    <div className="card o-hidden border-0 shadow-lg my-5">
                        <div className="card-body p-0" id='loginUser'>
                            ...
                            <h1 className='text-center mt-5'>
                                <b> <mark style={{ color: 'limegreen' }}>Digital Central Library</mark></b>
                            </h1>
                            <div className="row">
                                <div className="col-lg-6" id='customer-login'>
                                    <div className="p-5">
                                        <div className="text-center">
                                            <h1 className="h4 text-white mb-4"><mark>Customer Login!</mark></h1>
                                        </div>
                                        <form className="user">
                                ...
                                <div className="col-lg-6" id='librarian-login'>
                                    <div className="p-5">
                                        <div className="text-center">
                                            <h1 className="h4 text-white mb-4"><mark>Librarian Login!</mark></h1>
                                        </div>
                                        <form className="user">
                                            <div className="form-group">
